...
var $author$project$UiTests$events = {
	mouseEnter: function (_v0) {
		return _Utils_Tuple0;
	},
	mouseLeave: function (_v1) {
		return _Utils_Tuple0;
	}
};
...
var $author$project$Card$getDimensions = F2(
	function (link, summary) {
		...
		var thumbnailMaxSize = _v0.a;
		var thumbnailOtherDimension = _v0.b;
		var _v2 = isHorizontalPreview ? _Utils_Tuple2(thumbnailOtherDimension, thumbnailMaxSize) : _Utils_Tuple2(thumbnailMaxSize, thumbnailOtherDimension);
		var thumbnailWidth = _v2.a;
		var thumbnailHeight = _v2.b;
		var _v3 = isHorizontalPreview ? _Utils_Tuple2(extractWidth + thumbnailWidth, horizontalPreviewHeight) : _Utils_Tuple2(verticalPreviewWidth, verticalExtractMaxHeight + thumbnailHeight);
		var maxWidth = _v3.a;
		var maxHeight = _v3.b;
		var _v4 = _Utils_Tuple2(
			(rect.top + viewport.y) + rect.height,
			function () {
				var _v5 = link.contentDir;
				if (_v5.$ === 'LTR') {
		...
		var topPosition = _v4.a;
		var leftPosition = _v4.b;
...
var $author$project$Card$viewSummary = F3(
	function (link, dimensions, summary) {
		...
		var _v0 = dimensions;
		var constrainedSize = _v0.constrainedSize;
		var kind = _v0.kind;
		var extractOrder = _v0.extractOrder;
		var extractWidth = _v0.extractWidth;
		var extractMaxHeight = _v0.extractMaxHeight;
...
var $author$project$UiTests$viewCard = function (_v0) {
	var title = _v0.a;
	var _v1 = _v0.b;
	var link = _v1.a;
	var maybeSummary = _v1.b;
	var dismissed = _v1.c;
...
var $author$project$UiTests$viewIndex = function (_v0) {
	var title = _v0.a;
	var _v1 = _v0.b;
	var link = _v1.a;
	var maybeSummary = _v1.b;
...
var $author$project$UiTests$viewViewport = function (_v0) {
	var title = _v0.a;
	var _v1 = _v0.b;
	var link = _v1.a;
	var maybeSummary = _v1.b;
